        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Crafting pixel-perfect, responsive interfaces with React.js,
                Next.js, and modern UI frameworks. From SPAs to SEO-optimised
                sites, I deliver high-performing, scalable front-end solutions.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>CMS & TOOLS</h3>
              <h4>WordPress, Design & Performance</h4>
              <p>
                Building and managing sites with WordPress and Elementor. Using
                Figma for design handoff, GitHub for version control, and
                focus on responsive design, SEO, and site speed optimisation.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
